...
base_url = 'https://tombriches.com/'
wallet_url_deposit = 'https://tombriches.com/account/wallet/deposit'
wallet_url_withdrawal = 'https://tombriches.com/account/wallet/withdrawal'
